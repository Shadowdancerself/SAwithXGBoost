...
point_index = x.index('4')
y = df.iloc[1][1:]
point_mean = y[point_index]
#y_std = data.iloc[1][1:]
#point_std = y[point_index]
#ax.errorbar(x[point_index], point_mean, yerr=point_std, capsize=5, color='black', ecolor='black', capthick=1)
ax.plot(x[point_index], point_mean, marker='o', markersize=11, markerfacecolor='#DB5461', markeredgecolor='black',
                markeredgewidth=1)
ax.set_xlim([-1, 60])
