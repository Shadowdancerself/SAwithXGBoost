...
class HUD(object):
    ...
    def tick(self, world, clock):
        ...
        #Vector3D(x=7.950882, y=0.044771, z=0.000007)
        # VehicleControl
        c = world.player.get_control()
        #VehicleControl(throttle=0.850000, steer=0.000000, brake=0.000000, hand_brake=False, reverse=False, manual_gear_shift=False, gear=2)
        ...
        vdata = {'Vector3D_x': a1, 'Vector3D_y': a2, 'Vector3D_z': a3, 'speed_km/s': a4, 'throttle': a5, 'steer': a6, 'brake': a7}
        vdatas = []
        vdatas.append(vdata)
        ...
        if self.simulation_time == 1:
            csv_headers = ['Vector3D_x', 'Vector3D_y', 'Vector3D_z', 'speed_km/s', 'throttle', 'steer', 'brake']
            data.to_csv(r"C:\Users\q2929\Desktop\carla No editor\PythonAPI\examples\1201_result_t_v_c\test.csv", header=csv_headers, index=False, mode='a')
        else:
            data.to_csv(r"C:\Users\q2929\Desktop\carla No editor\PythonAPI\examples\1201_result_t_v_c\test.csv", header=False, index=False, mode='a')
